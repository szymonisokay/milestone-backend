...
export class Init1748175693991 implements MigrationInterface {
    name = 'Init1748175693991'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task_status" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "isCustom" boolean NOT NULL DEFAULT true, "workspaceId" uuid, CONSTRAINT "PK_b8747cc6a41b6cef4639babf61d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task_column" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "color" character varying NOT NULL, "statusId" uuid, "projectId" uuid, CONSTRAINT "REL_051fbac8ee18105c8fdac2f226" UNIQUE ("statusId"), CONSTRAINT "PK_4a2a36bbbaf0cfd82029c9c84d6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "identifier" character varying NOT NULL, "name" character varying, "description" character varying, "sprintId" uuid, "creatorId" uuid, "assigneeId" uuid, CONSTRAINT "UQ_b2c5b08af6c89f30ee37cea174a" UNIQUE ("identifier"), CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task_status" ADD CONSTRAINT "FK_7622c6117be04185c02d047a850" FOREIGN KEY ("workspaceId") REFERENCES "workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_column" ADD CONSTRAINT "FK_051fbac8ee18105c8fdac2f226c" FOREIGN KEY ("statusId") REFERENCES "task_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_column" ADD CONSTRAINT "FK_a03b6cfa2199fceed94ac14b843" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_column" DROP CONSTRAINT "FK_051fbac8ee18105c8fdac2f226c"`);
        await queryRunner.query(`ALTER TABLE "task_status" DROP CONSTRAINT "FK_7622c6117be04185c02d047a850"`);
